...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "SANATANI_BACCHA")
BOT_USERNAME = os.getenv("BOT_USERNAME", "PRAGYA_ROBOT")
...
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/tum_jaha_ham_wahi")
YOUTUBE = os.getenv("YOUTUBE", "https://youtube.com/@akgamers2413")
GITHUB = os.getenv("GITHUB", "https://github.com/newiseland")
DONATE = os.getenv("DONATE", "https://t.me/SIDHI_MUSIC/23")
